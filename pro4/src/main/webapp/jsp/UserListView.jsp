...
<body>
	...
	<center>
		...
		<form action="<%=ORSView.USER_LIST_CTL%>" name="frm" method="post">
			...
			<table width="100%">
				<tr>
					<td align="center"><label><b>Role :</b> </label><%=HTMLUtility.getList("roleId", String.valueOf(bean.getRoleId()), roleliList, "Role")%>
						&emsp;<label><b>First Name :</b></label> <input
						style="width: 200px; padding: 5px;" type="text" name="firstName"
						placeholder="Enter First Name"
						value="<%=ServletUtility.getParameter("firstName", request)%>">
						&emsp; <label><b>LoginId:</b></label> <input
						style="width: 200px; padding: 5px;" type="text" name="login"
			...
			<table border="1" width="100%">
				...
				<tr align="center">
					...
					<td><input type="checkbox" id="sid" name="chk_1"
						onchange="check()" value="<%=ubean.getId()%>"></td>
						<%} %>
					<td><%=index++%></td>
