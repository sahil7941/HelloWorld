...
<body>
	...
	<center>
		...
		<form action="<%=ORSView.FACULTY_LIST_CTL%>" name="frm" method="post">
			...
			<table width="100%">
				<tr>
					<td align="center"><label><b>Course:</b></label> <%=HTMLUtility.getList("courseId", String.valueOf(bean.getCourseId()), courseList, "Course")%>
						&emsp; <label><b>Full Name:</b></label> <%=HTMLUtility.getList("facultyId", String.valueOf(bean.getId()), facultyList, "Name")%>
						&emsp; <label><b>First Name :</b></label> <input
						style="width: 200px; padding: 5px;" type="text" name="firstName"
						placeholder="Enter First Name"
						value="<%=ServletUtility.getParameter("firstName", request)%>">
						&emsp; <label><b>Last Name :</b></label> <input
						style="width: 200px; padding: 5px;" type="text" name="lastName"
						placeholder="Enter Last Name"
						value="<%=ServletUtility.getParameter("lastName", request)%>">
						&emsp; <label> <input style="padding: 5px; width: 100px;"
			...
			<table border="1" width="100%">
				...
				<tr align="center">
					...
					<td><a href="ctl/FacultyCtl?id=<%=bean1.getId()%>">Edit</a></td>
				</tr>
				<%
					}
				%>
