...
<body>
	...
	<center>
		...
		<form action="<%=ORSView.COLLEGE_LIST_CTL%>" name="frm" method="POST">
			...
			<table width="100%">
				<tr>
					<td align="center"><label><b> Name : </b></label><%=HTMLUtility.getList("collegeId", String.valueOf(bean.getId()), collegeList, "College")%>&emsp;
						<label><b>City :</b></label> <input style="width: 200px; padding: 5px;"
						...
						name="operation" value="<%=CollegeListCtl.OP_SEARCH%>"></td>
				</tr>
			</table>
			<br>
			<table border="1" width="100%">
				...
				<tr align="center">
					<td><input type="checkbox" id="sid" name="chk_1"
						onchange="check()" value="<%=cBean.getId()%>"></td>
					<td><%=index++%></td>
					<td><%=cBean.getName()%></td>
