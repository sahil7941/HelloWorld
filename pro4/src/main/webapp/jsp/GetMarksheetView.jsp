	...
	<center>
		...
		<form action="<%=ORSView.GET_MARKSHEET_CTL%>" method="post">
			...
			<font
				...
				<input style="width: 200px; padding: 5px;" type="text" name="rollNo"
			...
			<table align="center" border="1" width="50%" height="50%">
				...
				<tr>
					<td colspan="5"><h3>
							Roll No :
							<%=DataUtility.getStringData(bean.getRollNo())%></h3></td>
				</tr>

				<tr>
					<td colspan="5"><h3>
							Student Name :
							<%=DataUtility.getStringData(bean.getName())%></h3></td>
				</tr>

				<tr align="center">
					<td rowspan="2" style="width: 20%; font-weight: bold;">Subject</td>
					<td rowspan="2" style="width: 20%; font-weight: bold;">Maximum
						Marks</td>
					<td rowspan="2" style="width: 20%; font-weight: bold;">Minimum
						Marks</td>
					<td colspan="2" style="width: 40%; font-weight: bold;">Marks
						Obtained</td>
				</tr>
				...
				<tr>
					<td colspan="2" align="center" style="font-weight: bold;">Grand
						Total</td>
