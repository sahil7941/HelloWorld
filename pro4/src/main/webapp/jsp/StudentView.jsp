	...
	<form action="<%=ORSView.STUDENT_CTL%>" method="post">
		...
		<table align="center" style="margin-left: 39%">
			...
			<tr>
				...
				<td><input style="width: 200px; padding: 5px;" type="text" name="lastName"
			...
			<tr>
				...
				<td><input style="width: 200px; padding: 5px;" type="text" name="email"
			...
			<tr>
				...
				<td><input style="width: 200px; padding: 5px;" type="text" name="mobileNo"
			...
			<tr>
				...
				<td><input style="width: 200px; padding: 5px;" type="text" name="dob" id="datepicker"
			...
			<tr>
				...
				<td><input style="width: 99px;" type="submit" name="operation"
					value="<%=(bean.getId() <= 0) ? StudentCtl.OP_SAVE : StudentCtl.OP_UPDATE%>">
					<input style="width: 97px;" type="submit" name="operation"
					value="<%=(bean.getId() <= 0) ? StudentCtl.OP_RESET : StudentCtl.OP_CANCEl%>"></td>
			</tr>
			<tr></tr>
		</table>
