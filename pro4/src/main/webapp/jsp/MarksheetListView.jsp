			...
			<table width="100%">
				<tr>
					<td align="center"><label style="font-size: 15px">
							<b>Student Name :</b></label> <%=HTMLUtility.getList("marksheetId", String.valueOf(bean.getId()), marksheetList,
						"Student List")%>
						&emsp; <label style="font-size: 15px"> <b>RollNo :</b></label> <input style="width: 200px; padding: 5px;"
						type="text" name="rollNo" placeholder="Enter Roll Number"
						value="<%=ServletUtility.getParameter("rollNo", request)%>">&emsp;
						<input style="padding: 5px; width: 100px;" type="submit"
						name="operation" value="<%=MarksheetListCtl.OP_SEARCH%>"></td>
				</tr>
			</table>
			<br>
			<table border="1" width="100%">
				...
				<tr align="center">
					<td><input type="checkbox" id="sid" name="chk_1"
						onchange="check()" value="<%=mbean.getId()%>"></td>
					<td><%=index++%></td>
