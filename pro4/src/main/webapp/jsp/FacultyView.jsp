		...
		<table class="t1">
			...
			<table align="center" style="margin-left: 39%">
				<tr>
					...
					<td><input style="width: 200px; padding: 5px;" type="text" name="firstName"
				...
				<tr>
					...
					<td><input style="width: 200px; padding: 5px;" type="text" name="lastName" size="26"
				...
				<tr>
					...
					<td><input style="width: 200px; padding: 5px;" type="text" name="qualification" size="26"
				...
				<tr>
					...
					<td><input style="width: 200px; padding: 5px;" type="text" name="emailId" size="26"
				...
				<tr>
					...
					<td><input style="width: 200px; padding: 5px;" type="text" name="mobNo" size="26"
				...
				<tr>
					...
					<td><input style="width: 200px; padding: 5px;" type="text" name="dob" id="datepicker" size="26"
						placeholder="Click Here" readonly="readonly"
				...
				<tr>
					...
					<td><input style="width: 99px;" type="submit" name="operation"
						...
						value="<%=(bean.getId() > 0) ? FacultyCtl.OP_CANCEl : FacultyCtl.OP_RESET%>"></td>
				</tr>
			</table>
