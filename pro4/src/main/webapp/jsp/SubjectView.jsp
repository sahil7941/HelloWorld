	...
	<form action="<%=ORSView.SUBJECT_CTL%>" method="post">
		...
		<table align="center" style="margin-left: 39%">
			<tr>
				...
				<td><%=HTMLUtility.getList("courseId", String.valueOf(bean.getCourseId()), l, "Course")%><font
					color="red"> <%=ServletUtility.getErrorMessage("courseId", request)%></font></td>
			</tr>

			<tr>
				<th align="left">Subject Name<font color="red">*</font></th>
				<td><input style="width: 200px; padding: 5px;" style="width: 200px; padding: 5px;"  type="text" name="name"
			...
			<tr>
				...
				<td><input style="width: 200px; padding: 5px;" type="text" name="description"
			...
			<tr>
				...
				<td><input type="submit" name="operation"
					value="<%=(bean.getId() <= 0) ? SubjectCtl.OP_SAVE : SubjectCtl.OP_UPDATE%>"
					style="width: 99px;"> <input type="submit" name="operation"
					value="<%=(bean.getId() <= 0) ? SubjectCtl.OP_RESET : SubjectCtl.OP_CANCEl%>"
					style="width: 97px;"></td>
			</tr>
		</table>
