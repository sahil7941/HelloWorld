		...
		<table align="center" style="margin-left: 39%">
			...
			<tr>
				...
				<td><input style="padding: 5px 28px; border-radius: 4px; width: 99px;"  type="submit" name="operation"
					...
					style="width: 99px;"> <input style="padding: 5px 28px; border-radius: 4px; width: 99px;"  type="submit" name="operation"
					value="<%=(bean.getId() <= 0) ? TimeTableCtl.OP_RESET : TimeTableCtl.OP_CANCEl%>" style="width: 97px;"></td>
			</tr>
