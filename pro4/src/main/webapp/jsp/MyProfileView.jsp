		...
		<center>
			...
			<table align="center" style="margin-left: 40%">
				...
				<tr>
					...
					<td><input style="width: 200px; padding: 5px;" type="text"
						name="dob" id="datepicker" readonly="readonly"
				...
				<tr>
					<td></td>
					<td><input style="padding: 5px ;border-radius: 4px; width: 125px;" type="submit"
						name="operation" value="<%=MyProfileCtl.OP_CHANGE_MY_PASSWORD%>">
						<input style="padding: 5px 18px; border-radius: 4px; width: 70px;" type="submit"
