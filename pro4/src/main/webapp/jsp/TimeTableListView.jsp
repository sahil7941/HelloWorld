...
<body>
	...
	<form action="<%=ORSView.TIMETABLE_LIST_CTL%>" name="frm" method="post">
		...
		<center>
			...
			<table width="100%">
				...
				<tr>
					<td align="center"><label><b>Course Name :</b> </label> <%=HTMLUtility.getList("courseId", String.valueOf(bean.getCourseId()), courseList, "Course")%>
						&emsp;<label><b>Semester :</b> </label> <%
 ...
 %> <%=htmlList%> &emsp;<label><b>Subject Name :</b> </label><input
						style="width: 200px; padding: 5px;" type="text" name="subjectName"
						placeholder="Enter Subject Name"
						value="<%=ServletUtility.getParameter("subjectName", request)%>">
						&emsp; <label><b>Exam Date :</b> </label><input
						style="width: 200px; padding: 5px;" type="text" name="examDate"
						id="datepicker2" placeholder="Date Of Exam(Click Here)"
						readonly="readonly"
						value="<%=ServletUtility.getParameter("examDate", request)%>">
						&emsp;<input style="padding: 5px; width: 100px;" type="submit"
						name="operation" value="<%=TimeTableListCtl.OP_SEARCH%>">
					</td>
				</tr>
			</table>
			<br>
			<table border="1" width="100%" align="center">
				...
				%>
				<tr align="center">
					<td><input type="checkbox" id="sid" name="chk_1"
						onchange="check()" value="<%=tbean.getId()%>"></td>
					<td><%=index++%></td>
			...
			<table width="100%" align="center">
				<tr>
					<td><input style="padding: 5px; width: 100px;" type="submit"
						name="operation" value="<%=TimeTableCtl.OP_PREVIOUS%>"
						<%if (pageNo == 1) {%> disabled="disabled" <%}%>></td>
					<td align="right"><input style="padding: 5px; width: 100px;"
						type="submit" name="operation" value="<%=TimeTableCtl.OP_NEW%>"></td>
					<td align="center"><input style="padding: 5px; width: 100px;"
						type="submit" name="operation" value="<%=TimeTableCtl.OP_RESET%>"></td>
					<td><input style="padding: 5px; width: 100px;" type="submit"
						name="operation" value="<%=TimeTableCtl.OP_DELETE%>"
						<%if (list.size() == 0) {%> disabled="disabled" <%}%>></td>
					<td></td>
					<td align="right"><input style="padding: 5px; width: 100px;"
						type="submit" name="operation" value="<%=TimeTableCtl.OP_NEXT%>"
			...
			<input style="padding: 5px; width: 100px;" type="submit"
				name="operation" value="<%=TimeTableListCtl.OP_BACK%>">
			<%
				}
			%>
		</center>
