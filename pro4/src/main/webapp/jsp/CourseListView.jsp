...
<body>
		...
		<center>
			...
			<form action="<%=ORSView.COURSE_LIST_CTL%>" name="frm" method="POST">
				...
				<table width="100%">
					<tr>
						<td align="center">
							<%-- <label>Name :</label> <%=HTMLUtility.getList("courseId", String.valueOf(bean.getName()),l)%>
						&emsp; --%> <label><b>Course Name :</b></label> <input
							style="width: 200px; padding: 5px;" type="text" name="name"
 ...
 %> <%=htmlList%>&emsp; <input style="padding: 5px; width: 100px;"
				...
				<table width="100%">
					<tr>
						...
						<td align="right"><input style="padding: 5px; width: 100px;"
							type="submit" name="operation" value="<%=CourseListCtl.OP_NEW%>"
						...
						%>
						<td align="right"><input style="padding: 5px; width: 100px;"
							type="submit" name="operation" value="<%=CourseListCtl.OP_NEXT%>"></td>
						<%
							}
						%>
					</tr>
				...
				<input style="padding: 5px; width: 100px;" type="submit"
					name="operation" value="<%=CourseListCtl.OP_BACK%>">
				<%
					}
				%>
			</form>
