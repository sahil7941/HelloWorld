...
<body>
	...
	<jsp:useBean id="collBean" class="in.co.sunrays.proj4.bean.CollegeBean"
		scope="request"></jsp:useBean>
	<center>
		<h1>Student List</h1>
		...
		<form action="<%=ORSView.STUDENT_LIST_CTL%>" name="frm" method="post">
			...
			<table width="100%">
				<tr>
					<td align="center"><label><b>College :</b> </label><%=HTMLUtility.getList("collegeid", String.valueOf(bean.getCollegeId()), collList, "College")%>&emsp;
						<label><b> FirstName :</b></label> <input
						style="width: 200px; padding: 5px;" type="text" name="firstName"
						placeholder="Enter First Name"
						value="<%=ServletUtility.getParameter("firstName", request)%>">&emsp;
						<label><b>LastName :</b></label> <input
						style="width: 200px; padding: 5px;" type="text" name="lastName"
			...
			<table border="1" width="100%">
				...
				<tr align="center">
					<td><input type="checkbox" id="sid" name="chk_1"
						onchange="check()" value="<%=sbean.getId()%>"></td>
					<td><%=index++%></td>
			...
			<table width="100%">
				<tr>
					...
					<td align="right"><input style="padding: 5px; width: 100px;"
						type="submit" name="operation" value="<%=StudentListCtl.OP_NEW%>"></td>
					...
					<td align="right"><input style="padding: 5px; width: 100px;"
						...
						<%if (pageSize > list.size() || model.nextPK() - 1 == sbean.getId()) {%>
			...
			%>
			<input style="padding: 5px; width: 100px;" type="submit"
				name="operation" value="<%=StudentListCtl.OP_BACK%>">
			<%
				}
			%>
		</form>
