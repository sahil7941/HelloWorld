...
<body>
	...
	<center>
		...
		<form action="<%=ORSView.SUBJECT_LIST_CTL%>" name="frm" method="post">
			...
			<table width="100%">
				<tr>
					<td align="center"><label><b>Course :</b> </label><%=HTMLUtility.getList("courseId", String.valueOf(bean.getCourseId()), cList, "Course")%>&emsp;
						<label><b>Subject Name :</b></label> <input
						style="width: 200px; padding: 5px;" type="text" name="name"
						placeholder="Enter Subject Name"
						value="<%=ServletUtility.getParameter("name", request)%>">
						&emsp; <input style="padding: 5px; width: 100px;" type="submit"
						name="operation" value="<%=SubjectListCtl.OP_SEARCH%>"></td>
				</tr>
			</table>
			<br>
