...
public class UserModelTest {
    ...
    public static void testAdd() throws ParseException,
        ...
        try {
            ...
            bean.setLogin("abhi1c746@gmail.com");
    ...
    public static void testUpdate() {
        ...
        try {
            UserBean bean = model.findByPK(47L);
            bean.setFirstName("cmc limited");
            bean.setLastName("pvt ltd");
            bean.setLogin("ranji210@gmail.com");
    ...
    public static void testAuthenticate() {
        ...
        try {
            UserBean bean = new UserBean();
            bean.setLogin("sunilmca575@gmail.com");
    ...
    public static void testchangePassword() {
        ...
        try {
            ...
            try {
                model.changePassword(17L, oldPassword, newPassword);
