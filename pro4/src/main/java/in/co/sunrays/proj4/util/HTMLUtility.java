...
public class HTMLUtility {
	...
	public static String getList(String name, String selectedVal, HashMap<String, String> map, String listName) {

		StringBuffer sb = new StringBuffer("<select style='width: 200px; padding: 5px;' name='" + name + "'>");

		Set<String> keys = map.keySet();
		String val = null;
		sb.append("<option selected value=''>--- Select " + listName + " ---</option>");
	 ...
	 * @return
	 */
	public static String getList(String name, String selectedVal, List list, String listName) {
		Collections.sort(list);

		List<DropdownListBean> dd = (List<DropdownListBean>) list;

		StringBuffer sb = new StringBuffer("<select style='width: 200px; padding: 5px;' name='" + name + "'>");
		sb.append("<option selected value='0'>--- Select " + listName + " ---</option>");
	...
	public static String getList(String name, String selectedVal, HashMap<String, String> map, boolean select) {
		...
		StringBuffer sb = new StringBuffer("<select class='drop' name='" + name + "'>");
