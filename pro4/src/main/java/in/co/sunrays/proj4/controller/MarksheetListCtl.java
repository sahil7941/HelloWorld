...
public class MarksheetListCtl extends BaseCtl {
	...
	protected void preload(HttpServletRequest request) {
		...
		/*
		 * StudentModel smodel = new StudentModel(); try { List slist =
		 * smodel.list(); request.setAttribute("studentList", slist); } catch
	 ...
	 * @param request:
	 *            HttpServletRequest object
	 * @return bean: MarksheetBean object
	 */
	@Override
	protected BaseBean populateBean(HttpServletRequest request) {
		...
		bean.setId(DataUtility.getLong(request.getParameter("marksheetId")));
	 ...
	 * 
	 * @return MarksheetListView.jsp: View page of MarksheetListCtl
	 */
	@Override
