...
public class TimeTableModel {
	...
	public long add(TimeTableBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			throw new ApplicationException("Exception : Exception in add TimeTable"+e);
		} finally {
			JDBCDataSource.closeConnection(conn);
		}
	...
	public TimeTableBean findTimeTableDuplicacy(Long courseId, String Semester, Date examdate)
		...
		try {
			...
			e.printStackTrace();
			log.error("Database Exception..", e);
			throw new ApplicationException("Exception : Exception in getting TimeTable"+e);
		} finally {
			JDBCDataSource.closeConnection(conn);
		}
	 ...
	 * @throws ApplicationException
	 */
	public TimeTableBean findTimeTableDuplicacy(Long courseId, String Semester, Long subjectId)
			throws ApplicationException {
		log.debug("Method FindTimeTable of Model TimeTable started");
		StringBuffer sql = new StringBuffer(
