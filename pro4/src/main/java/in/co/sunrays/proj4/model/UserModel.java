...
public class UserModel {
	...
	public boolean changePassword(Long id, String oldPassword, String newPassword)
			throws MessagingException, RecordNotFoundException, ApplicationException {
	...
	public long registerUser(UserBean bean) throws MessagingException, ApplicationException, DuplicateRecordException {
	...
	public boolean resetPassword(UserBean bean) throws MessagingException, ApplicationException {
	...
	public boolean forgetPassword(String login)
			throws MessagingException, ApplicationException, RecordNotFoundException {
		boolean flag = false;
		...
		EmailMessage msg = new EmailMessage();
		msg.setTo(login);
		msg.setSubject("SUNARYS ORS Password Recovered");
		msg.setMessage(message);
		msg.setMessageType(EmailMessage.HTML_MSG);
