...
public class CollegeCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		else if (!DataValidator.isFname(request.getParameter("state"))) {
		...
		else if (!DataValidator.isFname(request.getParameter("city"))) {
			request.setAttribute("city", PropertyReader.getValue("error.city", "city "));
			pass = false;
		}
	 ...
	 * @param request:
	 *            HttpServletRequest object
	 * @return bean: CollegeBean object
	 */
	@Override
