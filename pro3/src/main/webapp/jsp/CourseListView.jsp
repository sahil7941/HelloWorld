...
%>
 ...
 <!--
   ...
   <!--   <div class="modal-header justify-content-center">
		  ...
		  <%-- <form action="<%=ORSView.ROLE_LIST_CTL%>" method="post"> --%>
               <div class="row" style="margin-top:10px;">
                ...
                <%=HTMLUtility.getList("courseId", String.valueOf(dto.getId()), "Course", cList) %>
                </div>
				</div>
                ...
                <input type="text" 
                class="<%=(ServletUtility.getErrorMessage("duration", request).equalsIgnoreCase(""))?"form-control":"form-control border border-danger"%>" 
			    ...
			    <div class="col-md-1">
			    <div class="form-group">
                <input type="submit" class="form-control text-white btn btn-success btn-block" value="<%=CourseListCtl.OP_SEARCH%>" name="operation">
                </div>
				</div>
				<div class="col-md-1">
			    <div class="form-group">
                <input type="submit" class="form-control text-white btn btn-info btn-block" value="<%=CourseListCtl.OP_RESET%>" name="operation"/>
                </div>
				</div>
	<div class="col-md-3">
    ...
    <%-- <input type="submit" class="page-link text-white bg-primary"  value="<%=CourseListCtl.OP_PREVIOUS%>" name="operation" <%=(pageNo==1)? "disabled" : "" %>> --%>
   <input type="submit" class="<%=(pageNo==1)? "btn page-link text-secondary no-drop" : "btn page-link text-white bg-secondary"%>"  value="<%=CourseListCtl.OP_PREVIOUS%>" name="operation" <%=(pageNo==1)? "disabled" : "" %>>
    </li>
  ...
  <%--     <% List l1=(List)request.getAttribute("pageno"); 
                    %> --%>
      <input type="submit" class="<%=((list.size()<pageSize)||(l1.size()==pageSize*pageNo))? "btn page-link text-secondary no-drop" : "btn page-link text-white bg-secondary"%>"  value="<%=CourseListCtl.OP_NEXT%>" name="operation" <%=((list.size()<pageSize)||(l1.size()==pageSize*pageNo))? "disabled" : "" %>>
	...
	<div class="col-md-5">
	    <%
			   ...
			   <div class="form-group">
                ...
                style="margin-bottom:25px; "><%=onRecord%></h3>
...
<!-- 		<th width="20%">CreatedBy</th>
 -->		
      ...
      <%
              ...
              while (it.hasNext()) {
                  CourseDTO rdto = (CourseDTO)it.next();
          %>
    <tbody>
      ...
      <tr class="bg-light text-dark">
        ...
        <td width="20%" class="mouse"><%=rdto.getDuration()%></td>
...
<%-- 		<td width="20%" class="mouse"><%=rdto.getCreatedBy()%></td>
 --%>		
		<td width="20%">
              ...
              <a href="CourseCtl?id=<%=rdto.getId()%>" style="text-decoration:none; color:black; ">
  ...
  <div class="col-md-1">
	<div class="form-group">
    <input type="submit" class="form-control text-white btn btn-primary btn-block" value="<%=CourseListCtl.OP_NEW%>" name="operation" />
    </div>
	</div>
	
	<div class="col-md-1">
	<div class="form-group">
    <input type="submit" class="<%=(list.size()==0)?"form-control bg-danger text-white no-drop" :"form-control text-white btn btn-danger btn-block"%>" value="<%=CourseListCtl.OP_DELETE%>" name="operation" <%=(list.size()==0)? "disabled" : "" %>>
  ...
  <div class="row justify-content-center" style="margin-top: 10px;">
	<div class="col-md-1">
	<div class="form-group">
    <input type="submit" class="form-control text-white btn btn-secondary btn-block" value="<%=CourseListCtl.OP_BACK%>" name="operation" />
    </div>
	</div></div>
  <%} %>
</div>
