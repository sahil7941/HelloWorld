		  ...
		  <div class="modal-body">
			...
			<h3 
                ...
                style="margin-bottom:25px; "><%=error%><%=Sucess%></h3>    
			   	...
			   	<fieldset>
				<legend>Subject Information</legend></fieldset>
			    <div class="row">
			    <div class="col-md-6">
			    <div class="form-group">
                <label for="name">Subject Name<font color="red">*</font></label>
                
                <input type="text" 
                class="<%=(ServletUtility.getErrorMessage("subjectName", request).equalsIgnoreCase(""))?"form-control":"form-control border border-danger"%>" 
                ...
                <label for="sel1">Course Name<font color="red">*</font></label>
                 ...
                 %>
                 <%=HTMLUtility.getList("courseId",String.valueOf(dto.getCourseId()),list, err)%>  
                ...
                rows="3" id="comment" placeholder="Enter Description" name="description"><%=DataUtility.getStringData(dto.getDescription())%></textarea>
