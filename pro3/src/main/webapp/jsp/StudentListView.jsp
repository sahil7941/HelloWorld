...
%>
 ...
 <!--
   ...
   <!--   <div class="modal-header justify-content-center">
		  ...
		  <%-- <form action="<%=ORSView.ROLE_LIST_CTL%>" method="post"> --%>
			   ...
			   <div class="col-md-3">
                ...
                placeholder="Enter Student First Name"  name="firstName" 
			...
			<%-- 	<div class="col-md-3">
                ...
                placeholder="Enter Student Last Name"  name="lastName" 
			    ...
			    <div class="form-group">
                 ...
                 String err=ServletUtility.getErrorMessage("collegeId", request);
                		...
                		List slist=(List)request.getAttribute("collegeList");
                 
                 %>
                 <%=HTMLUtility.getList("collegeIdN",String.valueOf(dto.getCollegeID()),slist, err)%>  
			    ...
			    <div class="col-md-1">
			    <div class="form-group">
                <input type="submit" class="form-control text-white btn btn-success btn-block" value="<%=StudentListCtl.OP_SEARCH%>" name="operation">
                </div>
				</div>
				<div class="col-md-1">
			    <div class="form-group">
                <input type="submit" class="form-control text-white btn btn-info btn-block" value="<%=StudentListCtl.OP_RESET%>" name="operation"/>
                </div>
				</div>
	<div class="col-md-3">
  ...
  <div class="row">
    ...
    <%-- <input type="submit" class="page-link text-white bg-primary"  value="<%=StudentListCtl.OP_PREVIOUS%>" name="operation" <%=(pageNo==1)? "disabled" : "" %>> --%>
   <input type="submit" class="<%=(pageNo==1)? "btn page-link text-secondary no-drop" : "btn page-link text-white bg-secondary"%>"  value="<%=StudentListCtl.OP_PREVIOUS%>" name="operation" <%=(pageNo==1)? "disabled" : "" %>>
    </li>
   <% List l1=(List)request.getAttribute("pageno"); 
    ...
    <%-- 
      <% List l1=(List)request.getAttribute("pageno"); 
                    %> --%>
      <input type="submit" class="<%=((list.size()<pageSize)||(l1.size()==pageSize*pageNo))? "btn page-link text-secondary no-drop" : "btn page-link text-white bg-secondary"%>"  value="<%=StudentListCtl.OP_NEXT%>" name="operation" <%=((list.size()<pageSize)||(l1.size()==pageSize*pageNo))? "disabled" : "" %>>
	...
	<div class="col-md-5">
	    <%
			   ...
			   <div class="form-group">
                ...
                <h3
                class="<%=(ServletUtility.getErrorMessage("onerecord",request).equalsIgnoreCase(""))?"text-center text-success":"text-center text-danger"%>"
...
<%if(list!=null && list.size()!=0) {%>
 <!--<h2>Basic Table</h2>
  ...
  <table class="table table-responsive table-bordered" style="width:100%; margin-top:-25px;">
    ...
    <label class="form-check-label">
      ...
      <%
              ...
              while (it.hasNext()) {
                  StudentDTO rdto = (StudentDTO)it.next();
          %>
    <tbody>
      ...
      <tr class="bg-light text-dark">
        ...
        <td width="20%" class="mouse"><%=rdto.getCollegeName()%></td>
		
		<td width="20%" class="mouse"><%=rdto.getMobileNo()%></td>
		
		<td width="20%">
		
              <a href="StudentCtl?id=<%=rdto.getId()%>" style="text-decoration:none; color:black; ">
  ...
  <tr class="bg-dark" width="100%" >
   ...
   <div class="col-md-1">
	<div class="form-group">
    <input type="submit" class="form-control text-white btn btn-primary btn-block" value="<%=StudentListCtl.OP_NEW%>" name="operation" />
    </div>
	</div>
	
	<div class="col-md-1">
	<div class="form-group">
    <input type="submit" class="<%=(list.size()==0)?"form-control bg-danger text-white no-drop" :"form-control text-white btn btn-danger btn-block"%>" value="<%=StudentListCtl.OP_DELETE%>" name="operation" <%=(list.size()==0)? "disabled" : "" %>>
   ...
   <div class="row justify-content-center" style="margin-top: 10px;">
	<div class="col-md-1">
	<div class="form-group">
    <input type="submit" class="form-control text-white btn btn-success btn-block" value="<%=StudentListCtl.OP_BACK%>" name="operation" />
    </div>
	</div></div>
   <%} %>
</div>
