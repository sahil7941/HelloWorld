...
/*	public static void setUserModel(UserModelJDBCImpl model, HttpServletRequest request) {
...
*/
	...
	public static BaseDTO getDTO(HttpServletRequest request) {
		return (BaseDTO) request.getAttribute("bean");
	}

/*	public static boolean isLoggedIn(HttpServletRequest request) {
		UserModelJDBCImpl model = (UserModelJDBCImpl) request.getSession().getAttribute("user");
		return model != null;
	}
*/
