...
public class MarksheetModelHibImpl implements MarksheetModelInt {
	 ...
	 * 
	 * @param pk
	 *            : get parameter @return dto @throws
	...
	/**
	 * Searche Marksheet with pagination
	 * 
	...
	public List getMeritList(int pageNo, int pageSize) throws ApplicationException {
		...
		try {
			...
			/*
			 * // if page size is greater than zero then apply pagination if
			 * (pageSize > 0) { pageNo = ((pageNo - 1) * pageSize) + 1;
			...
			query.setFirstResult((pageNo - 1 * pageSize) + 1);
